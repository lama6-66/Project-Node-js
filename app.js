...
app.get("/AddUser",async(req,res)=>{
  try{
    ...
    const countriesList=response.data.map(country => country.name.common ).sort();

     res.render("common", { body: "AddUser" ,isEdit:false,countries:countriesList});
  }catch(error){
...
app.get("/view/:id",(req,res)=>{
  ...
  res.render("common", { body: "view",user: result });
  })
})
